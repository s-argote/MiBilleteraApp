                ...
                <Animated.View style={{ transform: [{ scale: scaleAnim }] }}>
                    <View style={styles.previewCard}>
                        ...
                        >
                            ...
                            <Text style={styles.previewText}>{name.trim() || 'Nombre de categoría'}</Text>
                            <View style={styles.previewMeta}>
                                <Ionicons name="pricetag" size={12} color="rgba(255,255,255,0.8)" />
                                <Text style={styles.previewMetaText}>Categoría existente</Text>
                            </View>
                        </LinearGradient>
                    </View>
                </Animated.View>
                ...
                <View style={styles.formContainer}>
                    ...
                    <View style={styles.infoCard}>
                        ...
                        <Text style={styles.infoText}>
                            Puedes modificar el nombre o el color de la categoría. Los cambios se reflejarán en tus transacciones y gráficos.
                        </Text>
                    </View>
                </View>
            </ScrollView>
